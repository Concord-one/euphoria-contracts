...
contract sCCRD is ERC20Permit, Policy {
    ...
    constructor() ERC20('Staked WAGMI', 'sCCRD', 9) ERC20Permit() {
    ...
    /**
        @notice increases sCCRD supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sCCRD
